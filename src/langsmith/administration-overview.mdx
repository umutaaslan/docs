...
Applications are built on top of [resource tags](/langsmith/administration-overview#resource-tags) and can be used to control resource access using [ABAC, currently in private preview](/langsmith/organization-workspace-operations#access-policies).
