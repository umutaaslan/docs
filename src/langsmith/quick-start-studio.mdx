...
This will load Studio connected to your live deployment, allowing you to create, read, and update the [threads](/oss/langgraph/persistence#threads), [assistants](/langsmith/assistants), and [memory](/oss/concepts/memory) in that deployment.
