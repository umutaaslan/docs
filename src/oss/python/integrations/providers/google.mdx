...
### Chat models
<Note>
    **For Gemini models**, use [`ChatGoogleGenerativeAI`](/oss/integrations/chat/google_generative_ai) from `langchain-google-genai` instead of `ChatVertexAI`. It supports both Gemini Developer API and Vertex AI backends.
...
<Columns cols={2}>
    <Card title="ChatVertexAI" icon="comments" href="/oss/integrations/chat/google_vertex_ai" cta="Get started" arrow>
        **Deprecated** – Use [`ChatGoogleGenerativeAI`](/oss/integrations/chat/google_generative_ai) for Gemini models instead.
    </Card>
...
<Columns cols={2}>
    ...
    <Card title="VertexAI" icon="i-cursor" href="/oss/integrations/llms/google_vertex_ai" cta="Get started" arrow>
        **Deprecated** – Use [`GoogleGenerativeAI`](/oss/integrations/llms/google_generative_ai) for Gemini models instead.
    </Card>
</Columns>
...
<Columns cols={2}>
    <Card title="VertexAIEmbeddings" icon="layer-group" href="/oss/integrations/text_embedding/google_vertex_ai" cta="Get started" arrow>
        **Deprecated** – Use [`GenerativeAIEmbeddings`](/oss/integrations/text_embedding/google_generative_ai) instead.
    </Card>
</Columns>
...
<Columns cols={2}>
    <Card title="Text-to-Speech" icon="volume-high" href="/oss/integrations/tools/google_cloud_texttospeech" cta="Get started" arrow>
...
<Columns cols={2}>
    ...
    <Card title="Google Finance" href="/oss/integrations/tools/google_finance" cta="Get started" arrow>
        Query financial data.
    </Card>
    <Card title="Google Jobs" href="/oss/integrations/tools/google_jobs" cta="Get started" arrow>
        Query job listings.
    </Card>
    <Card title="Google Lens" href="/oss/integrations/tools/google_lens" cta="Get started" arrow>
        Perform visual searches.
    </Card>
    <Card title="Google Places" href="/oss/integrations/tools/google_places" cta="Get started" arrow>
        Search for places information.
    </Card>
    <Card title="Google Scholar" href="/oss/integrations/tools/google_scholar" cta="Get started" arrow>
        Search academic papers.
    </Card>
    <Card title="Google Trends" href="/oss/integrations/tools/google_trends" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="SearchApi" icon="magnifying-glass" href="/oss/integrations/tools/searchapi" cta="Get started" arrow>
        searchapi.io provides API access to Google search results, YouTube, and more.
    </Card>
    <Card title="SerpApi" icon="magnifying-glass" href="/oss/integrations/tools/serpapi" cta="Get started" arrow>
        SerpApi provides API access to Google search results.
    </Card>
    <Card title="Serper.dev" icon="magnifying-glass" href="/oss/integrations/tools/google_serper" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="Search tool" icon="youtube" href="/oss/integrations/tools/youtube" cta="Get started" arrow>
        Search YouTube videos without the official API.
    </Card>
    <Card title="Audio loader" icon="youtube" href="/oss/integrations/document_loaders/youtube_audio" cta="Get started" arrow>
        Download audio from YouTube videos.
    </Card>
    <Card title="Transcripts loader" icon="youtube" href="/oss/integrations/document_loaders/youtube_transcript" cta="Get started" arrow>
